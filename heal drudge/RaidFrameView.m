...
//    CGContextFillRect(context, rectangle);
    ...
    [self drawGradientFromPoint:rectangle.origin
                        toPoint:CGPointMake(rectangle.origin.x,
                                            rectangle.origin.y + rectangle.size.height)
                     startColor:self.entity.hdClass.classColor
                       endColor:[UIColor darkGrayColor]
                   clippingPath:CGPathCreateWithRect(rectangle, NULL)];
}
