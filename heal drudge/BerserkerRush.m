...
- (id)init
{
    if ( self = [super init] )
    {
        ...
        self.tooltip = @"argath cuts his way towards you dealing 67% weapon damage to all targets in front of him, as well as increasing his physical damage done by 15% every 2 sec for 20 sec. Kargath's movement speed also increases by 40% every 2 sec for 20 sec.";
